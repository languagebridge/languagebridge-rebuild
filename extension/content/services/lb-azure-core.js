...
// Language map and shared utilities. Single source of truth for all 22 supported languages.
...
window.LB_LANGUAGES = {
  ...
  uzbek:       { code: 'uzbek',       label: 'Uzbek',        nativeLabel: 'Oʻzbek',      rtl: false },
  ...
  amharic:     { code: 'amharic',     label: 'Amharic',      nativeLabel: 'አማርኛ',        rtl: false },
  tagalog:     { code: 'tagalog',     label: 'Tagalog',      nativeLabel: 'Tagalog',     rtl: false },
  kinyarwanda: { code: 'kinyarwanda', label: 'Kinyarwanda',  nativeLabel: 'Ikinyarwanda', rtl: false },
  twi:         { code: 'twi',         label: 'Twi',          nativeLabel: 'Twi',         rtl: false },
  tigrinya:    { code: 'tigrinya',    label: 'Tigrinya',     nativeLabel: 'ትግርኛ',        rtl: false },
};
